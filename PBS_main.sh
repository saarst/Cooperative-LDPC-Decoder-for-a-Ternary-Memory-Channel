...
"/usr/local/matlab/bin/matlab" -nodisplay -r "ternary_batch_simulation_main(${n}, ${log_p}, ${R}, ${numIter}, ${batchSize}, ${sequence[0]}, ${sequence[1]}, '${experimentName}_$(date +%Y%m%d%H%M%S)' )" > "$output_file" 2> "$error_file"